...
│  Members: Chief Technology Officer · Chief Privacy Officer          │
...
│  • Program coordination         │     │  • First point of contact   │
│  • Use case triage and review   │     │    for AI use case queries  │
│  • AI System Inventory          │     │  • Facilitate local AI Use  │
│  • Training program             │     │    Case Request submissions │
│  • Regulatory monitoring        │     │  • Monitor local AI use     │
│  • Incident coordination        │     │  • Escalate shadow AI       │
...
│  │   interpret-│  │ • EU AI Act │  │   robustness│  │   cal     │  │
...
**AI governance responsibilities:**
- Approves high-risk AI system deployments, with power to delegate limited-risk approvals to the AI Governance Program Office (AGPO)
- Reviews and acts on quarterly AI Governance Dashboard presented by the AGPO
- Reviews material AI incidents within 30 days of closure
- Approves updates to the Responsible AI Policy
- Escalation point for disputes between system owners and the AGPO
...
- Documents community input provided; the AGPO documents decisions made as a result, or explicit rationale for decisions made against community input
...
| **Procurement** | The AGPO provides an AI governance assessment checklist for use in vendor procurement. Procurement notifies the AGPO of AI-related vendor selections before contract signature. Vendor AI is not approved for use until an AUCR has been completed and the vendor AI governance assessment is on file. |
| **Internal Audit** | Internal Audit includes AI governance program effectiveness in its annual plan. The AGPO provides audit access to the AI System Inventory, risk assessments, and approval documentation. |
